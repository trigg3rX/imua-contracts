...
type TaskDefinition struct {
	...
	RestrictedOperatorIds      []common.Address
...
// AvsHook is a free data retrieval call binding the contract method 0x20d2c137.
//
// Solidity: function avsHook() view returns(address)
func (_TriggerXAvs *TriggerXAvsCaller) AvsHook(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _TriggerXAvs.contract.Call(opts, &out, "avsHook")
...
//
// Solidity: function avsHook() view returns(address)
func (_TriggerXAvs *TriggerXAvsSession) AvsHook() (common.Address, error) {
	return _TriggerXAvs.Contract.AvsHook(&_TriggerXAvs.CallOpts)
}

// AvsHook is a free data retrieval call binding the contract method 0x20d2c137.
//
// Solidity: function avsHook() view returns(address)
func (_TriggerXAvs *TriggerXAvsCallerSession) AvsHook() (common.Address, error) {
	return _TriggerXAvs.Contract.AvsHook(&_TriggerXAvs.CallOpts)
}
...
//
// Solidity: function getTaskDefinition(uint8 id) view returns((uint8,string,uint256,uint256,uint256,uint256,address[],uint256))
...
// CreateTask is a paid mutator transaction binding the contract method 0x303a6aad.
//
// Solidity: function createTask(string taskName, uint8 taskDefinitionId, bytes taskData, uint64 taskResponsePeriod, uint64 taskChallengePeriod, uint8 thresholdPercentage, uint64 taskStatisticalPeriod) returns(uint64 taskID)
func (_TriggerXAvs *TriggerXAvsTransactor) CreateTask(opts *bind.TransactOpts, taskName string, taskDefinitionId uint8, taskData []byte, taskResponsePeriod uint64, taskChallengePeriod uint64, thresholdPercentage uint8, taskStatisticalPeriod uint64) (*types.Transaction, error) {
	return _TriggerXAvs.contract.Transact(opts, "createTask", taskName, taskDefinitionId, taskData, taskResponsePeriod, taskChallengePeriod, thresholdPercentage, taskStatisticalPeriod)
}

// CreateTask is a paid mutator transaction binding the contract method 0x303a6aad.
//
// Solidity: function createTask(string taskName, uint8 taskDefinitionId, bytes taskData, uint64 taskResponsePeriod, uint64 taskChallengePeriod, uint8 thresholdPercentage, uint64 taskStatisticalPeriod) returns(uint64 taskID)
func (_TriggerXAvs *TriggerXAvsSession) CreateTask(taskName string, taskDefinitionId uint8, taskData []byte, taskResponsePeriod uint64, taskChallengePeriod uint64, thresholdPercentage uint8, taskStatisticalPeriod uint64) (*types.Transaction, error) {
	return _TriggerXAvs.Contract.CreateTask(&_TriggerXAvs.TransactOpts, taskName, taskDefinitionId, taskData, taskResponsePeriod, taskChallengePeriod, thresholdPercentage, taskStatisticalPeriod)
}

// CreateTask is a paid mutator transaction binding the contract method 0x303a6aad.
//
// Solidity: function createTask(string taskName, uint8 taskDefinitionId, bytes taskData, uint64 taskResponsePeriod, uint64 taskChallengePeriod, uint8 thresholdPercentage, uint64 taskStatisticalPeriod) returns(uint64 taskID)
func (_TriggerXAvs *TriggerXAvsTransactorSession) CreateTask(taskName string, taskDefinitionId uint8, taskData []byte, taskResponsePeriod uint64, taskChallengePeriod uint64, thresholdPercentage uint8, taskStatisticalPeriod uint64) (*types.Transaction, error) {
	return _TriggerXAvs.Contract.CreateTask(&_TriggerXAvs.TransactOpts, taskName, taskDefinitionId, taskData, taskResponsePeriod, taskChallengePeriod, thresholdPercentage, taskStatisticalPeriod)
}

// CreateTaskDefinition is a paid mutator transaction binding the contract method 0x1df407dd.
//
// Solidity: function createTaskDefinition(string name, uint256 baseRewardFeeForAttesters, uint256 baseRewardFeeForPerformer, uint256 baseRewardFeeForAggregator, uint256 minimumVotingPower, address[] restrictedOperatorIds, uint256 maximumNumberOfAttesters) returns(uint8 taskDefinitionId)
func (_TriggerXAvs *TriggerXAvsTransactor) CreateTaskDefinition(opts *bind.TransactOpts, name string, baseRewardFeeForAttesters *big.Int, baseRewardFeeForPerformer *big.Int, baseRewardFeeForAggregator *big.Int, minimumVotingPower *big.Int, restrictedOperatorIds []common.Address, maximumNumberOfAttesters *big.Int) (*types.Transaction, error) {
	return _TriggerXAvs.contract.Transact(opts, "createTaskDefinition", name, baseRewardFeeForAttesters, baseRewardFeeForPerformer, baseRewardFeeForAggregator, minimumVotingPower, restrictedOperatorIds, maximumNumberOfAttesters)
}

// CreateTaskDefinition is a paid mutator transaction binding the contract method 0x1df407dd.
//
// Solidity: function createTaskDefinition(string name, uint256 baseRewardFeeForAttesters, uint256 baseRewardFeeForPerformer, uint256 baseRewardFeeForAggregator, uint256 minimumVotingPower, address[] restrictedOperatorIds, uint256 maximumNumberOfAttesters) returns(uint8 taskDefinitionId)
func (_TriggerXAvs *TriggerXAvsSession) CreateTaskDefinition(name string, baseRewardFeeForAttesters *big.Int, baseRewardFeeForPerformer *big.Int, baseRewardFeeForAggregator *big.Int, minimumVotingPower *big.Int, restrictedOperatorIds []common.Address, maximumNumberOfAttesters *big.Int) (*types.Transaction, error) {
	return _TriggerXAvs.Contract.CreateTaskDefinition(&_TriggerXAvs.TransactOpts, name, baseRewardFeeForAttesters, baseRewardFeeForPerformer, baseRewardFeeForAggregator, minimumVotingPower, restrictedOperatorIds, maximumNumberOfAttesters)
}

// CreateTaskDefinition is a paid mutator transaction binding the contract method 0x1df407dd.
//
// Solidity: function createTaskDefinition(string name, uint256 baseRewardFeeForAttesters, uint256 baseRewardFeeForPerformer, uint256 baseRewardFeeForAggregator, uint256 minimumVotingPower, address[] restrictedOperatorIds, uint256 maximumNumberOfAttesters) returns(uint8 taskDefinitionId)
func (_TriggerXAvs *TriggerXAvsTransactorSession) CreateTaskDefinition(name string, baseRewardFeeForAttesters *big.Int, baseRewardFeeForPerformer *big.Int, baseRewardFeeForAggregator *big.Int, minimumVotingPower *big.Int, restrictedOperatorIds []common.Address, maximumNumberOfAttesters *big.Int) (*types.Transaction, error) {
	return _TriggerXAvs.Contract.CreateTaskDefinition(&_TriggerXAvs.TransactOpts, name, baseRewardFeeForAttesters, baseRewardFeeForPerformer, baseRewardFeeForAggregator, minimumVotingPower, restrictedOperatorIds, maximumNumberOfAttesters)
}
...
// SetAvsHook is a paid mutator transaction binding the contract method 0xcf6e59cc.
//
// Solidity: function setAvsHook(address _avsHook) returns()
func (_TriggerXAvs *TriggerXAvsTransactor) SetAvsHook(opts *bind.TransactOpts, _avsHook common.Address) (*types.Transaction, error) {
	return _TriggerXAvs.contract.Transact(opts, "setAvsHook", _avsHook)
}

// SetAvsHook is a paid mutator transaction binding the contract method 0xcf6e59cc.
//
// Solidity: function setAvsHook(address _avsHook) returns()
func (_TriggerXAvs *TriggerXAvsSession) SetAvsHook(_avsHook common.Address) (*types.Transaction, error) {
	return _TriggerXAvs.Contract.SetAvsHook(&_TriggerXAvs.TransactOpts, _avsHook)
}

// SetAvsHook is a paid mutator transaction binding the contract method 0xcf6e59cc.
//
// Solidity: function setAvsHook(address _avsHook) returns()
func (_TriggerXAvs *TriggerXAvsTransactorSession) SetAvsHook(_avsHook common.Address) (*types.Transaction, error) {
	return _TriggerXAvs.Contract.SetAvsHook(&_TriggerXAvs.TransactOpts, _avsHook)
}
...
// UpdateTaskDefinition is a paid mutator transaction binding the contract method 0x70ed1ac8.
//
// Solidity: function updateTaskDefinition(uint8 taskDefinitionId, string name, uint256 baseRewardFeeForAttesters, uint256 baseRewardFeeForPerformer, uint256 baseRewardFeeForAggregator, uint256 minimumVotingPower, address[] restrictedOperatorIds, uint256 maximumNumberOfAttesters) returns()
func (_TriggerXAvs *TriggerXAvsTransactor) UpdateTaskDefinition(opts *bind.TransactOpts, taskDefinitionId uint8, name string, baseRewardFeeForAttesters *big.Int, baseRewardFeeForPerformer *big.Int, baseRewardFeeForAggregator *big.Int, minimumVotingPower *big.Int, restrictedOperatorIds []common.Address, maximumNumberOfAttesters *big.Int) (*types.Transaction, error) {
	return _TriggerXAvs.contract.Transact(opts, "updateTaskDefinition", taskDefinitionId, name, baseRewardFeeForAttesters, baseRewardFeeForPerformer, baseRewardFeeForAggregator, minimumVotingPower, restrictedOperatorIds, maximumNumberOfAttesters)
}

// UpdateTaskDefinition is a paid mutator transaction binding the contract method 0x70ed1ac8.
//
// Solidity: function updateTaskDefinition(uint8 taskDefinitionId, string name, uint256 baseRewardFeeForAttesters, uint256 baseRewardFeeForPerformer, uint256 baseRewardFeeForAggregator, uint256 minimumVotingPower, address[] restrictedOperatorIds, uint256 maximumNumberOfAttesters) returns()
func (_TriggerXAvs *TriggerXAvsSession) UpdateTaskDefinition(taskDefinitionId uint8, name string, baseRewardFeeForAttesters *big.Int, baseRewardFeeForPerformer *big.Int, baseRewardFeeForAggregator *big.Int, minimumVotingPower *big.Int, restrictedOperatorIds []common.Address, maximumNumberOfAttesters *big.Int) (*types.Transaction, error) {
	return _TriggerXAvs.Contract.UpdateTaskDefinition(&_TriggerXAvs.TransactOpts, taskDefinitionId, name, baseRewardFeeForAttesters, baseRewardFeeForPerformer, baseRewardFeeForAggregator, minimumVotingPower, restrictedOperatorIds, maximumNumberOfAttesters)
}

// UpdateTaskDefinition is a paid mutator transaction binding the contract method 0x70ed1ac8.
//
// Solidity: function updateTaskDefinition(uint8 taskDefinitionId, string name, uint256 baseRewardFeeForAttesters, uint256 baseRewardFeeForPerformer, uint256 baseRewardFeeForAggregator, uint256 minimumVotingPower, address[] restrictedOperatorIds, uint256 maximumNumberOfAttesters) returns()
func (_TriggerXAvs *TriggerXAvsTransactorSession) UpdateTaskDefinition(taskDefinitionId uint8, name string, baseRewardFeeForAttesters *big.Int, baseRewardFeeForPerformer *big.Int, baseRewardFeeForAggregator *big.Int, minimumVotingPower *big.Int, restrictedOperatorIds []common.Address, maximumNumberOfAttesters *big.Int) (*types.Transaction, error) {
	return _TriggerXAvs.Contract.UpdateTaskDefinition(&_TriggerXAvs.TransactOpts, taskDefinitionId, name, baseRewardFeeForAttesters, baseRewardFeeForPerformer, baseRewardFeeForAggregator, minimumVotingPower, restrictedOperatorIds, maximumNumberOfAttesters)
}
...
// TriggerXAvsAVSRegisteredIterator is returned from FilterAVSRegistered and is used to iterate over the raw logs and unpacked data for AVSRegistered events raised by the TriggerXAvs contract.
type TriggerXAvsAVSRegisteredIterator struct {
	Event *TriggerXAvsAVSRegistered // Event containing the contract specifics and raw log
...
func (it *TriggerXAvsAVSRegisteredIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TriggerXAvsAVSRegistered)
...
func (it *TriggerXAvsAVSRegisteredIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TriggerXAvsAVSRegisteredIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TriggerXAvsAVSRegistered represents a AVSRegistered event raised by the TriggerXAvs contract.
type TriggerXAvsAVSRegistered struct {
	Sender  common.Address
	AvsName string
	Raw     types.Log // Blockchain specific contextual infos
}

// FilterAVSRegistered is a free log retrieval operation binding the contract event 0xaf4750c5d527b74526f2ef1c85f716c7b41fc9bc4934658b391fed997a30306e.
//
// Solidity: event AVSRegistered(address indexed sender, string avsName)
func (_TriggerXAvs *TriggerXAvsFilterer) FilterAVSRegistered(opts *bind.FilterOpts, sender []common.Address) (*TriggerXAvsAVSRegisteredIterator, error) {
	...
	logs, sub, err := _TriggerXAvs.contract.FilterLogs(opts, "AVSRegistered", senderRule)
	if err != nil {
		return nil, err
	}
	return &TriggerXAvsAVSRegisteredIterator{contract: _TriggerXAvs.contract, event: "AVSRegistered", logs: logs, sub: sub}, nil
}

// WatchAVSRegistered is a free log subscription operation binding the contract event 0xaf4750c5d527b74526f2ef1c85f716c7b41fc9bc4934658b391fed997a30306e.
//
// Solidity: event AVSRegistered(address indexed sender, string avsName)
func (_TriggerXAvs *TriggerXAvsFilterer) WatchAVSRegistered(opts *bind.WatchOpts, sink chan<- *TriggerXAvsAVSRegistered, sender []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _TriggerXAvs.contract.WatchLogs(opts, "AVSRegistered", senderRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(TriggerXAvsAVSRegistered)
				if err := _TriggerXAvs.contract.UnpackLog(event, "AVSRegistered", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseAVSRegistered is a log parse operation binding the contract event 0xaf4750c5d527b74526f2ef1c85f716c7b41fc9bc4934658b391fed997a30306e.
//
// Solidity: event AVSRegistered(address indexed sender, string avsName)
func (_TriggerXAvs *TriggerXAvsFilterer) ParseAVSRegistered(log types.Log) (*TriggerXAvsAVSRegistered, error) {
	event := new(TriggerXAvsAVSRegistered)
	if err := _TriggerXAvs.contract.UnpackLog(event, "AVSRegistered", log); err != nil {
		return nil, err
	}
...
// TriggerXAvsAVSUpdatedIterator is returned from FilterAVSUpdated and is used to iterate over the raw logs and unpacked data for AVSUpdated events raised by the TriggerXAvs contract.
type TriggerXAvsAVSUpdatedIterator struct {
	Event *TriggerXAvsAVSUpdated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TriggerXAvsAVSUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TriggerXAvsAVSUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TriggerXAvsAVSUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TriggerXAvsAVSUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TriggerXAvsAVSUpdated represents a AVSUpdated event raised by the TriggerXAvs contract.
type TriggerXAvsAVSUpdated struct {
	Sender  common.Address
	AvsName string
	Raw     types.Log // Blockchain specific contextual infos
}

// FilterAVSUpdated is a free log retrieval operation binding the contract event 0x50af6500d3bfe7b1b0deb194a21088adbd49e6e1ab750758941001e2b9cc6330.
//
// Solidity: event AVSUpdated(address indexed sender, string avsName)
func (_TriggerXAvs *TriggerXAvsFilterer) FilterAVSUpdated(opts *bind.FilterOpts, sender []common.Address) (*TriggerXAvsAVSUpdatedIterator, error) {
	...
	logs, sub, err := _TriggerXAvs.contract.FilterLogs(opts, "AVSUpdated", senderRule)
	if err != nil {
		return nil, err
	}
	return &TriggerXAvsAVSUpdatedIterator{contract: _TriggerXAvs.contract, event: "AVSUpdated", logs: logs, sub: sub}, nil
}

// WatchAVSUpdated is a free log subscription operation binding the contract event 0x50af6500d3bfe7b1b0deb194a21088adbd49e6e1ab750758941001e2b9cc6330.
//
// Solidity: event AVSUpdated(address indexed sender, string avsName)
func (_TriggerXAvs *TriggerXAvsFilterer) WatchAVSUpdated(opts *bind.WatchOpts, sink chan<- *TriggerXAvsAVSUpdated, sender []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _TriggerXAvs.contract.WatchLogs(opts, "AVSUpdated", senderRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TriggerXAvsAVSUpdated)
				if err := _TriggerXAvs.contract.UnpackLog(event, "AVSUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseAVSUpdated is a log parse operation binding the contract event 0x50af6500d3bfe7b1b0deb194a21088adbd49e6e1ab750758941001e2b9cc6330.
//
// Solidity: event AVSUpdated(address indexed sender, string avsName)
func (_TriggerXAvs *TriggerXAvsFilterer) ParseAVSUpdated(log types.Log) (*TriggerXAvsAVSUpdated, error) {
	event := new(TriggerXAvsAVSUpdated)
	if err := _TriggerXAvs.contract.UnpackLog(event, "AVSUpdated", log); err != nil {
		return nil, err
	}
...
// FilterChallengeSubmitted is a free log retrieval operation binding the contract event 0x6cf4c85e0ba2b659537b756e69e2988dec41b383523425ab03274ea4dd445824.
//
// Solidity: event ChallengeSubmitted(uint64 taskId, address taskAddress)
func (_TriggerXAvs *TriggerXAvsFilterer) FilterChallengeSubmitted(opts *bind.FilterOpts) (*TriggerXAvsChallengeSubmittedIterator, error) {

	logs, sub, err := _TriggerXAvs.contract.FilterLogs(opts, "ChallengeSubmitted")
	if err != nil {
		return nil, err
	}
...
// WatchChallengeSubmitted is a free log subscription operation binding the contract event 0x6cf4c85e0ba2b659537b756e69e2988dec41b383523425ab03274ea4dd445824.
//
// Solidity: event ChallengeSubmitted(uint64 taskId, address taskAddress)
func (_TriggerXAvs *TriggerXAvsFilterer) WatchChallengeSubmitted(opts *bind.WatchOpts, sink chan<- *TriggerXAvsChallengeSubmitted) (event.Subscription, error) {

	logs, sub, err := _TriggerXAvs.contract.WatchLogs(opts, "ChallengeSubmitted")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParseChallengeSubmitted is a log parse operation binding the contract event 0x6cf4c85e0ba2b659537b756e69e2988dec41b383523425ab03274ea4dd445824.
//
// Solidity: event ChallengeSubmitted(uint64 taskId, address taskAddress)
...
// FilterTaskCreated is a free log retrieval operation binding the contract event 0x3770d85872e6cdc2ef45f8860ce1ab5b51738dfe0e044e2326a9b197e08ade8d.
//
// Solidity: event TaskCreated(uint256 taskId, address issuer, string name, uint8 taskDefinitionId, bytes taskData, uint64 taskResponsePeriod, uint64 taskChallengePeriod, uint8 thresholdPercentage, uint64 taskStatisticalPeriod)
func (_TriggerXAvs *TriggerXAvsFilterer) FilterTaskCreated(opts *bind.FilterOpts) (*TriggerXAvsTaskCreatedIterator, error) {

	logs, sub, err := _TriggerXAvs.contract.FilterLogs(opts, "TaskCreated")
	if err != nil {
		return nil, err
	}
...
// WatchTaskCreated is a free log subscription operation binding the contract event 0x3770d85872e6cdc2ef45f8860ce1ab5b51738dfe0e044e2326a9b197e08ade8d.
//
// Solidity: event TaskCreated(uint256 taskId, address issuer, string name, uint8 taskDefinitionId, bytes taskData, uint64 taskResponsePeriod, uint64 taskChallengePeriod, uint8 thresholdPercentage, uint64 taskStatisticalPeriod)
func (_TriggerXAvs *TriggerXAvsFilterer) WatchTaskCreated(opts *bind.WatchOpts, sink chan<- *TriggerXAvsTaskCreated) (event.Subscription, error) {

	logs, sub, err := _TriggerXAvs.contract.WatchLogs(opts, "TaskCreated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParseTaskCreated is a log parse operation binding the contract event 0x3770d85872e6cdc2ef45f8860ce1ab5b51738dfe0e044e2326a9b197e08ade8d.
//
// Solidity: event TaskCreated(uint256 taskId, address issuer, string name, uint8 taskDefinitionId, bytes taskData, uint64 taskResponsePeriod, uint64 taskChallengePeriod, uint8 thresholdPercentage, uint64 taskStatisticalPeriod)
...
// TriggerXAvsTaskDefinitionUpdatedIterator is returned from FilterTaskDefinitionUpdated and is used to iterate over the raw logs and unpacked data for TaskDefinitionUpdated events raised by the TriggerXAvs contract.
type TriggerXAvsTaskDefinitionUpdatedIterator struct {
	Event *TriggerXAvsTaskDefinitionUpdated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TriggerXAvsTaskDefinitionUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TriggerXAvsTaskDefinitionUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TriggerXAvsTaskDefinitionUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TriggerXAvsTaskDefinitionUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TriggerXAvsTaskDefinitionUpdated represents a TaskDefinitionUpdated event raised by the TriggerXAvs contract.
type TriggerXAvsTaskDefinitionUpdated struct {
	TaskDefinitionId uint8
	Name             string
	Raw              types.Log // Blockchain specific contextual infos
}

// FilterTaskDefinitionUpdated is a free log retrieval operation binding the contract event 0xdeaba4b09b38f230fdd1af7441f3458b71d182f464703df4181a8ad01bbb85ce.
//
// Solidity: event TaskDefinitionUpdated(uint8 indexed taskDefinitionId, string name)
func (_TriggerXAvs *TriggerXAvsFilterer) FilterTaskDefinitionUpdated(opts *bind.FilterOpts, taskDefinitionId []uint8) (*TriggerXAvsTaskDefinitionUpdatedIterator, error) {
	...
	logs, sub, err := _TriggerXAvs.contract.FilterLogs(opts, "TaskDefinitionUpdated", taskDefinitionIdRule)
	if err != nil {
		return nil, err
	}
	return &TriggerXAvsTaskDefinitionUpdatedIterator{contract: _TriggerXAvs.contract, event: "TaskDefinitionUpdated", logs: logs, sub: sub}, nil
}

// WatchTaskDefinitionUpdated is a free log subscription operation binding the contract event 0xdeaba4b09b38f230fdd1af7441f3458b71d182f464703df4181a8ad01bbb85ce.
//
// Solidity: event TaskDefinitionUpdated(uint8 indexed taskDefinitionId, string name)
func (_TriggerXAvs *TriggerXAvsFilterer) WatchTaskDefinitionUpdated(opts *bind.WatchOpts, sink chan<- *TriggerXAvsTaskDefinitionUpdated, taskDefinitionId []uint8) (event.Subscription, error) {
	...
	logs, sub, err := _TriggerXAvs.contract.WatchLogs(opts, "TaskDefinitionUpdated", taskDefinitionIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TriggerXAvsTaskDefinitionUpdated)
				if err := _TriggerXAvs.contract.UnpackLog(event, "TaskDefinitionUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseTaskDefinitionUpdated is a log parse operation binding the contract event 0xdeaba4b09b38f230fdd1af7441f3458b71d182f464703df4181a8ad01bbb85ce.
//
// Solidity: event TaskDefinitionUpdated(uint8 indexed taskDefinitionId, string name)
func (_TriggerXAvs *TriggerXAvsFilterer) ParseTaskDefinitionUpdated(log types.Log) (*TriggerXAvsTaskDefinitionUpdated, error) {
	event := new(TriggerXAvsTaskDefinitionUpdated)
	if err := _TriggerXAvs.contract.UnpackLog(event, "TaskDefinitionUpdated", log); err != nil {
		return nil, err
	}
