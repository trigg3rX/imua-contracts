...
contract TriggerGasRegistryDeploy is Script {
    function run() public {
        ...
        bytes memory implementation_code = type(TriggerGasRegistryImua).creationCode;
        ...
        bytes memory initData = abi.encodeWithSelector(TriggerGasRegistryImua.initialize.selector, deployer);
        ...
        console.log("Proxy owner:", TriggerGasRegistryImua(payable(proxy)).owner());
